...
accuracy_ratio
```
The accuracy ratio is about 96% now, which is much better than the unscaled data. This result corroborates the graph; visually the scaled clusters are cleaner than the unscaled clusters. 
